    ...
    window.data.then(function(loaded_data) {
      ...
      if (results.length) {
        ...
        results.forEach(function(result) {
          ...
          var appendString = '<div class="index--single-post"> <div class="post-header"> <h1 class="post-title"><a href="' + item.url + '">' + item.title + '</a></h1> <p class="post-meta">Posted on <span class="date-meta">' + item.date + '</span> by <span class="author-meta"><a href="' + item.author_url + '"> ' + item.author + ' </a></span> </p> </div> <div class="content"> <div class="excerpt"> ' + item.content + ' </div>   </div> </div>';
